...
<table>
  ...
  <tr>
    ...
    <td>17-factor live scoring across every connection 🤖</td>
  </tr>
  <tr>
...
<sub>The Auto-Combo engine scores every candidate on **17 factors** (health, quota, cost, latency, task fit, quality, session availability…) — see [`docs/routing/AUTO-COMBO.md`](docs/routing/AUTO-COMBO.md).</sub>
...
- **🧠 Jarvis/O9 autonomous supervisor (fork)** — `jarvis-auto` routes Claude Code through a self-maintaining strict-zero-cost pool, then plan-included subscription capacity, with optional double-gated budgeted paid escalation. Live discovery, Claude tool probes, provider-diversity ranking, lifecycle/cooldown state, a spend ledger, and the Free Pool observatory keep routing auditable. → [Provider Runtime State](docs/architecture/PROVIDER_RUNTIME_STATE.md) · [Runbook](docs/runbooks/JARVIS_AUTONOMOUS_FREE_POOL.md)
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/routing/AUTO-COMBO.md">Auto-Combo Engine</a></b></td><td>17-factor scoring, mode packs, self-healing</td></tr>
