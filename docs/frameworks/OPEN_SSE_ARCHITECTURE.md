...
- Runs the **17-factor scoring** algorithm (`services/autoCombo/`)
...
| `auto`              | Use 17-factor scoring (`autoCombo/`)                                      |
...
- `services/autoCombo/` — 17-factor scoring, 8 auto routing strategies
...
- [AUTO-COMBO.md](../routing/AUTO-COMBO.md) — 17-factor scoring
